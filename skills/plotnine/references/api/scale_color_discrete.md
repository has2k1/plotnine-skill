...
`scale_color_discrete( h=15, c=100, l=65, direction=1, *, name=None, breaks=True, limits=None, labels=True, expand=None, guide="legend", na_value="#7F7F7F", aesthetics=(), drop=True, na_translate=True, s=None, color_space=None )`
