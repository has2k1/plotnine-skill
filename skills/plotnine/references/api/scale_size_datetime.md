...
`scale_size_datetime( date_breaks=None, date_labels=None, date_minor_breaks=None, range=(1, 6), *, name=None, breaks=True, limits=None, labels=True, expand=None, guide="legend", na_value=np.nan, aesthetics=(), rescaler=rescale, oob=censor, minor_breaks=True, trans="datetime" )`
...
| `range` | tuple[float, float] | `(1, 6)` | Range ([Minimum, Maximum]) of the size. |
