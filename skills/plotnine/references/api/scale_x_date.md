...
`scale_x_date( date_breaks=None, date_labels=None, date_minor_breaks=None, *, name=None, breaks=True, limits=None, labels=True, expand=None, guide=None, na_value=np.nan, aesthetics=(), rescaler=rescale, oob=censor, minor_breaks=True, trans="datetime" )`
