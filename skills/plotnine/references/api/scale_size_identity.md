...
`scale_size_identity( *, name=None, breaks=True, limits=None, labels=True, expand=None, guide=None, na_value=np.nan, aesthetics=(), rescaler=rescale, oob=censor, minor_breaks=True, trans=None )`
