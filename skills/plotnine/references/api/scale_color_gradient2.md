...
`scale_color_gradient2( low="#832424", mid="#FFFFFF", high="#3A3A98", midpoint=0, *, name=None, breaks=True, limits=None, labels=True, expand=None, guide="colorbar", na_value="#7F7F7F", aesthetics=(), rescaler=rescale, oob=censor, minor_breaks=True, trans=None )`

## Parameters

| Param | Type | Default | Description |
|-------|------|---------|-------------|
| `low` | str | `'#832424'` | Low color. |
| `mid` | str | `'#FFFFFF'` | Mid-point color. |
| `high` | str | `'#3A3A98'` | High color. |
| `midpoint` | float | `0` | Mid point of the input data range. |
