...
`scale_size( range=(1, 6), *, name=None, breaks=True, limits=None, labels=True, expand=None, guide="legend", na_value=np.nan, aesthetics=(), rescaler=rescale, oob=censor, minor_breaks=True, trans=None )`
