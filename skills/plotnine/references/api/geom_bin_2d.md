...
`geom_bin_2d( mapping=None, data=None, *, stat="bin_2d", position="identity", na_rm=False, inherit_aes=True, show_legend=None, raster=False, **kwargs )`
...
| `stat` | str \| stat | `"bin_2d"` | The statistical transformation to use on the data for this layer. If it is a string, it must be the registered and known to Plotnine. |
