...
`geom_errorbarh( mapping=None, data=None, *, stat="identity", position="identity", na_rm=False, inherit_aes=True, show_legend=None, raster=False, height=0.5, **kwargs )`
...
| `height` | float | `0.5` | Bar height as a fraction of the resolution of the data. |
