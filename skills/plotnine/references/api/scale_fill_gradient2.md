...
`scale_fill_gradient2( low="#832424", mid="#FFFFFF", high="#3A3A98", midpoint=0, *, name=None, breaks=True, limits=None, labels=True, expand=None, guide="colorbar", na_value="#7F7F7F", aesthetics=(), rescaler=rescale, oob=censor, minor_breaks=True, trans=None )`
