...
`geom_errorbar( mapping=None, data=None, *, stat="identity", position="identity", na_rm=False, inherit_aes=True, show_legend=None, raster=False, width=0.5, **kwargs )`
...
| `width` | float | `0.5` | Bar width as a fraction of the resolution of the data. |
