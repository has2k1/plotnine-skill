...
`geom_sina( mapping=None, data=None, *, stat="sina", position="dodge", na_rm=False, inherit_aes=True, show_legend=None, raster=False, **kwargs )`
...
| `stat` | str \| stat | `"sina"` | The statistical transformation to use on the data for this layer. If it is a string, it must be the registered and known to Plotnine. |
